...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('28VBumDsYN', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I7n7IgXYCn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4p8mBHoSse', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\HouseRepository' => ['privates', 'App\\Repository\\HouseRepository', 'getHouseRepositoryService', true],
        ], [
    ...
    {
        return $this->privates['annotations.cached_reader'] = new \Doctrine\Common\Annotations\PsrCachedReader(($this->privates['annotations.reader'] ??= new \Doctrine\Common\Annotations\AnnotationReader()), $this->getAnnotations_CacheAdapterService(), true);
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ze60qF6Te8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6n5Hdyqeab', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o9SxMZLdi6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_house_api_platform_doctrine_orm_filter_range_filter' => ['privates', 'annotated_app_entity_house_api_platform_doctrine_orm_filter_range_filter', 'getAnnotatedAppEntityHouseApiPlatformDoctrineOrmFilterRangeFilterService', true],
            'annotated_app_entity_house_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_house_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityHouseApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_house_api_platform_serializer_filter_property_filter' => ['privates', 'annotated_app_entity_house_api_platform_serializer_filter_property_filter', 'getAnnotatedAppEntityHouseApiPlatformSerializerFilterPropertyFilterService', true],
        ], [
            'annotated_app_entity_house_api_platform_doctrine_orm_filter_range_filter' => '?',
            'annotated_app_entity_house_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_house_api_platform_serializer_filter_property_filter' => '?',
        ]);
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZpRs-9775K', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lVADKPVLuU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('07iHv-kbS+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zoVK29El31', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lQ-lFxoGwb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    protected function getDebug_SerializerService()
    {
        ...
        $b = ($this->privates['serializer.data_collector'] ??= new \Symfony\Component\Serializer\DataCollector\SerializerDataCollector());
        $c = ($this->privates['property_info'] ?? $this->getPropertyInfoService());
        $d = new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL), $b);

        $e = new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $a, $c)], [0 => $d])), $b)), $b);
        ...
        $o = ($this->privates['api_platform.security.resource_access_checker'] ?? $this->getApiPlatform_Security_ResourceAccessCheckerService());

        if (isset($this->privates['debug.serializer'])) {
            return $this->privates['debug.serializer'];
        }
        $p = new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $g, $a, $c, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($n), NULL), $b);

        return $this->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), $b), 1 => $e, 2 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($f, [], $g), $b), 3 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $g), $b), 4 => $e, 5 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($h, $i, $j, $k, $f, $g), $b), 6 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($h, $l, $f), $b), 7 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($f, true), $b), 8 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), $b), 9 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), $b), 10 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $b), 11 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($h, $i, $j, $l, $k, $m, $a, $g, $n, [], $o), $b), 12 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Serializer\ItemNormalizer($i, $j, $l, $k, $a, $g, $n, NULL, $h, $o), $b), 13 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $b), 14 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $g), $b), 15 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $b), 16 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $b), 17 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $b), 18 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $b), 19 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), $b), 20 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $b), 21 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($m, $k, $l, NULL), 'page', 'pagination', $h, $a), $h, $k, ($this->privates['api_platform.filter_locator'] ?? $this->getApiPlatform_FilterLocatorService())), $b), 22 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $b), 23 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($p, $l, $m), $b), 24 => $p], [0 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $b), 1 => $d, 2 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), $b), 3 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $b), 4 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $b), 5 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $b)]), $b);
    }
